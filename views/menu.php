...
$allMenu = $model->getAll($limit, $offset, $search, $activeKategori);
$totalData = $model->countAll($search, $activeKategori);
$totalPages = ceil($totalData / $limit);
$kategoriList = $model->getCategories();
?>
